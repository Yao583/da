...
# --- Quiz 4: allocation process ---
    ...
    quiz27 = models.StringField(
        ...
        choices=[
            ['No', 'No, once you are unpaired from a prize, that prize becomes unavailable to you. This means that if you were unpaired from a Prize A, you cannot be re-paired to any of the two Prize As. If you are unpaired from a prize, you can only be paired to other prizes that nobody else is paired with.'],
            ['Yes', 'Yes'],
        ],
        widget=widgets.RadioSelect,
    )
...
class InstructionsQuiz(Page):
    ...
    form_fields = ['quiz1', 'quiz2', 'quiz3', 'quiz4', 'quiz5', 'quiz6', 'quiz7', 'quiz8', 'quiz9',
        ...
        'quiz6_attempts', 'failed_quiz', 'ai_tel_instructionsquiz']
