...
doc = """
Boston mechanism with Prolific integration: one Prolific participant replaces a lab participant per round; other choices/rankings are loaded from lab session data.
"""
...
class InstructionsQuiz(Page):
    ...
    form_fields = ['quiz1', 'quiz2', 'quiz3', 'quiz4', 'quiz5', 'quiz6', 'quiz7', 'quiz8', 'quiz9',
        ...
        'quiz28', 'quiz29', 'quiz30', 'quiz1_attempts', 'quiz2_attempts', 'quiz3_attempts',
        'quiz4_attempts', 'quiz5_attempts', 'failed_quiz']
