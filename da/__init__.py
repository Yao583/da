...
doc = """
Deferred Acceptance, Prolific online version. The participant plays 5 rounds alone against
computer-generated valuations, submitting a complete ranking each round. There is no seed
data and no live allocation: after a full group of 8 usable finishers is assembled (in the
survey app) the Deferred Acceptance mechanism is run post-hoc to compute bonuses.
"""
